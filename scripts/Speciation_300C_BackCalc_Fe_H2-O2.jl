...
function Speciation(logaoxides, T_calc, P)
    ...
    MgCl          = (CSV.read("/Users/guillaumesiron/Documents/Julia_scripts/ReactiveTransport1D/data/MgCl+_dissociation_300C.csv", DataFrame))
    ...
    HCl           = (CSV.read("/Users/guillaumesiron/Documents/Julia_scripts/ReactiveTransport1D/data/HCl_dissociation_300C.csv", DataFrame))
    LogK_HCl      = collect(HCl[:,2])                  # Log K values for HCl dissociation
    H2O           = (CSV.read("/Users/guillaumesiron/Documents/Julia_scripts/ReactiveTransport1D/data/H2O_dissociation_300C.csv", DataFrame))
    LogK_H2O      = collect(H2O[:,2])                  # Log K values for H2O dissociation
    MgOH          = (CSV.read("/Users/guillaumesiron/Documents/Julia_scripts/ReactiveTransport1D/data/MgOH+_dissociation_300C.csv", DataFrame))
    LogK_MgOH     = collect(MgOH[:,2])                 # Log K values for MgOH dissociation
    FeCl          = (CSV.read("/Users/guillaumesiron/Documents/Julia_scripts/ReactiveTransport1D/data/FeCl+_dissociation_300C.csv", DataFrame))
    LogK_FeCl     = collect(FeCl[:,2])                 # Log K values for FeCl+ dissociation
    FeCl2         = (CSV.read("/Users/guillaumesiron/Documents/Julia_scripts/ReactiveTransport1D/data/FeCl2_dissociation_300C.csv", DataFrame))
    LogK_FeCl2    = collect(FeCl2[:,2])                # Log K values for FeCl+ dissociation
    FeOH          = (CSV.read("/Users/guillaumesiron/Documents/Julia_scripts/ReactiveTransport1D/data/FeOH+_dissociation_300C.csv", DataFrame))
    LogK_FeOH     = collect(FeOH[:,2])                 # Log K values for MgOH dissociation
    H2_H2O        = (CSV.read("/Users/guillaumesiron/Documents/Julia_scripts/ReactiveTransport1D/data/H2(aq)-H2O_dissociation_300C.csv", DataFrame))
...
G0_Mg_lt   = (CSV.read("/Users/guillaumesiron/Documents/Julia_scripts/ReactiveTransport1D/data/G0_Mg2+_300C.csv", DataFrame))
G0_SiO2_lt = (CSV.read("/Users/guillaumesiron/Documents/Julia_scripts/ReactiveTransport1D/data/G0_SiO2(aq)_300C.csv", DataFrame))
G0_Fe_lt   = (CSV.read("/Users/guillaumesiron/Documents/Julia_scripts/ReactiveTransport1D/data/G0_Fe2+_300C.csv", DataFrame))
G0_O2_lt   = (CSV.read("/Users/guillaumesiron/Documents/Julia_scripts/ReactiveTransport1D/data/G0_O2_300C.csv", DataFrame))
